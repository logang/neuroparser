"""
Copy of Chaco scalar_image_function_inspector adapted for parameterized error surfaces.
"""
...
# Local imports 
from brain.get_results import test_data, _get_results 

# Useful functions
pjoin = os.path.join

# Data Import
results_base = '/media/500A/Results/GraphNet/resubmission/CV25/'
filename = 'NaiveGraphNet25.mat'
...
class Model( HasTraits ):
    ...
    def __init__(self, params, *args, **kwargs):
        ...
        self.compute_model()
        self.lambda1 = params['l1']
        self.lambdaG = params['lG']

    def load_data(self):
        self.xs   = self.lambdaG
        self.xs   = self.lambda1
        self.zs   = self.data_slice
...
options_dict = {'colormap' : "gmt_drywet", 
                'num_levels' : 15,
